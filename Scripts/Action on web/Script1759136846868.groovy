...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Recruitment_oxd-main-menu-item'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Personal Details_orangehrm-tabs-item'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OrangeHRM/button_Password_oxd-button oxd-button--medi_8860b7'), 
    0)
