...
WebUI.setText(findTestObject('Object Repository/Page_Contact  Practice Test Automation  Sel_b632b1/input__wpforms-161-field_0'), 
    'rita')

WebUI.setText(findTestObject('Object Repository/Page_Contact  Practice Test Automation  Sel_b632b1/input_First_wpforms-161-field_0-last'), 
    'jhamnani')

WebUI.click(findTestObject('Object Repository/Page_Contact  Practice Test Automation  Sel_b632b1/button_Phone_wpforms-submit-161'))
